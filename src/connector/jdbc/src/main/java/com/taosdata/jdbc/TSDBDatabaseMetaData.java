...
//            ResultSetMetaData metaData = getTablesResultSet.getMetaData();
//            while (getTablesResultSet.next()){
//                for (int i = 1; i <= metaData.getColumnCount(); i++) {
//                    System.out.print(i + "==>" + metaData.getColumnLabel(i) + ":" + getTablesResultSet.getString(i)+ "\t");
//                }
//                System.out.println();
//            }
    ...
    public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern) throws SQLException {
        ...
        try (Statement stmt = conn.createStatement()) {
            if (null != conn && !conn.isClosed()) {
                ...
                stmt.executeUpdate("use " + catalog);
                ResultSet resultSet = stmt.executeQuery("describe " + catalog + "." + tableNamePattern);
                GetColumnsResultSet getColumnsResultSet = new GetColumnsResultSet(resultSet, catalog, schemaPattern, tableNamePattern, columnNamePattern);
